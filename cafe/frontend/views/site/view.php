...
<div class="single-product cold-md-12">
   ...
   <div class="product-details col-md-6">
      ...
      <a href="<?= Yii::$app->urlManager->createUrl(['site/flipbook', 'id' => $product->id]) ?>" class="btn btn-warning" style="padding-top: 5px; margin-top: 20px; font-size: 18px; font-weight: bold; color: #FFFFFF; background-color: #5a423b!important; width: 181px;height: 35px; margin-left: 90px;">
                            ...
                            <div class="col-6">
                                <div class="box_total" style="display: flex; border-bottom: 1px solid black; border-opacity: 0.5; width: 100%;">
                                    <div class="box_1" style="flex-grow: 1/3; width: 50%;">
                                        ...
                                        <h5 style="text-align: center; font-size: 35px; margin-left: 350px;"><?= $averageRating ?></h5>
