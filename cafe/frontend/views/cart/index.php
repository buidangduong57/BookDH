                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="index.php?r=cart/update&id=<?=$product->id?>" class="form-inline" method="post">
                                        <input type="number" min="1" max="100" name="quantity" style="margin-top: 43px;" value='<?=$product->quantity?>' class="qty"/>
                                        <input type="submit" value="Cập nhật" style="margin-left: -13px;height: 30px; margin-top: 15px;" class="btn btn-warning">
                                    </form>
                                </td>
                                <td class="cart-total">
